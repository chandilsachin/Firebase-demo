...
public class CloudDatabaseActivity extends AppCompatActivity implements Initializer {
    ...
    public void initialize() {
        ...
        //TODO("change following line to get data reference of desired location in firebase database, Hint: 'Users/{uid}' ")
        ...
        mUserInfoChangeListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                //TODO("add code to get user info and update UI using `setUserData(user)` method")
    ...
    public void saveUserDataOnFirebaseDatabase() {
        ...
        if (userAcc != null) {
            ...
            //TODO("pass user object in place of null to send data to firebase database")
            mDatabaseReference.setValue(null, (databaseError, databaseReference) -> {
    ...
    protected void onStop() {
        ...
        //TODO("pass ValueEventListener to detach from firebase database ")
        mDatabaseReference.removeEventListener((ValueEventListener) null);
    }
}
